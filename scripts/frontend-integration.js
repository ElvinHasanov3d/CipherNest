 ...
 * This file demonstrates how to integrate Ciphernest with a web frontend
 */

// For React/Vue/Angular applications
export class CiphernestClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CiphernestClient(provider, contractAddress);
